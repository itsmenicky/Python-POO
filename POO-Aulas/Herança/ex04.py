...
# Para cada funcionário, é necessário saber seu nome, endereço, telefone, cpf e salário. 
# Para cada professor é necessário saber sua titulação e as disciplinas que ele leciona. Para cada técnico administrativo é necessário saber seu cargo.
# Para cada aluno é necessário saber seu nome, endereco, telefone, cpf e disciplinas que ele cursa. Para cada disciplina é necessário registrar seu nome.
...
class Aluno(Pessoa):
    ...
    def incluir_disciplina(self, materia):
